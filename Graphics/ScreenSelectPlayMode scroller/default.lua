...
GainFocusCommand=function(self) self:finishtweening():visible(true):diffusealpha(0.75):zoom(1.1):easeinoutsine(0.25):zoom(1):diffusealpha(1) end;
...
-- Emblem Frame
	Def.ActorFrame {
		...
		Def.Sprite {
			...
			OnCommand=function(self) self:diffusealpha(0):zoom(1.2):sleep(0.2):easeinoutsine(0.3):diffusealpha(1):zoom(1) end;
			GainFocusCommand=function(self) self:finishtweening():zoom(1):diffusealpha(1) end;
			LoseFocusCommand=function(self) self:finishtweening():easeoutsine(0.4):diffusealpha(0):zoom(0.75) end;
			OffFocusedCommand=function(self) self:finishtweening():easeoutquint(0.3):diffusealpha(0):zoom(1.2) end;
		};		
	...
	-- Text Frame
	Def.ActorFrame {
		OnCommand=function(self) self:diffusealpha(0):sleep(0.2):easeinoutsine(0.3):diffusealpha(1) end;
		Def.BitmapText {
			Font="_Large Bold";
			Text=string_name;
			InitCommand=function(self) self:y(160):skewx(-0.15):zoom(1) end;
			GainFocusCommand=function(self) self:finishtweening():easeinoutsine(0.45):diffusealpha(1) end;
			LoseFocusCommand=function(self) self:finishtweening():decelerate(0.45):diffusealpha(0) end;
			OffFocusedCommand=function(self) self:finishtweening():easeoutquint(0.3):diffusealpha(0):zoomx(1.1) end;
		};
		Def.BitmapText {
