...
return Def.ActorFrame {
	Def.ActorFrame {
		OnCommand=function(self) self:diffusealpha(0):zoom(0.75):easeoutsine(0.3):diffusealpha(1):zoom(1) end;
		OffCommand=function(self) self:easeoutsine(0.3):diffusealpha(0):zoom(0.75) end;
		Def.Quad {
	...
	-- Stripes
		...
		Def.BitmapText {
			...
			InitCommand=function(self) self:maxwidth(232):zoom(1):y(-08) end;
		...
		Def.BitmapText {
			...
			InitCommand=function(self) self:maxwidth(232):zoom(0.75):y(20) end;
			GainFocusCommand=function(self) self:stoptweening():linear(0.08):diffuse( ColorTable["menuTextGainFocus"] ):diffusealpha(1) end;
			LoseFocusCommand=function(self) self:stoptweening():linear(0.08):diffuse( ColorTable["menuTextLoseFocus"] ):diffusealpha(0.3) end;
		};	
		Def.Quad {
