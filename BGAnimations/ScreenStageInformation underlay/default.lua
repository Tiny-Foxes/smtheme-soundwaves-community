...
if getenv("CurrentlyInSong") == false then
	...
	t[#t+1] = Def.Quad {
		...
		OnCommand=function(self)
			self:decelerate(0.6):zoomto(SCREEN_WIDTH,SCREEN_HEIGHT)
		end;
	  };
	-- Scanline
	t[#t+1] = Def.Quad {
		...
		OnCommand=function(self)
			self:decelerate(0.6):y(SCREEN_BOTTOM)
		end;
	  };
	...
	t[#t+1] = Def.ActorFrame {
		InitCommand=function(self) self:xy(credit_position,SCREEN_TOP+30) end;
		OnCommand=function(self)
			self:diffusealpha(0):addx(credit_x_start):sleep(titleFadeIn)
			:decelerate(titleAnimLength):diffusealpha(1):addx(20*credit_x_add):sleep(titleWait):decelerate(0.5):diffusealpha(0)
		end;
			Def.Sprite {
...
t[#t+1] = Def.ActorFrame {
	InitCommand=function(self)
		self:xy(SCREEN_RIGHT-16,SCREEN_BOTTOM-110)
	end;
	OnCommand=function(self)
...
t[#t+1] = stage_num_actor .. {
	InitCommand=function(self) 
		...
		:x(SCREEN_LEFT+10):y(SCREEN_BOTTOM-68)
