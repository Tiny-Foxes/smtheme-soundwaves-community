...
return Def.ActorFrame {
	Def.Quad {
		...
		StartTransitioningCommand=function(self)
			self:diffuse(color("#41ba67")):decelerate(0.5):diffuse(color("#246b3a")):sleep(0.2):easeinquint(0.12):zoomtoheight(0)
		end;
	};
	Def.Sprite {
		Texture="_wave",
		...
		StartTransitioningCommand=function(self)
			self:diffusealpha(1):easeoutcubic(0.3):diffusealpha(0):zoomx(1.4)
		end;
	};	
	Def.Sprite {
		Texture="go",
